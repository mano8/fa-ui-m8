"""Live-test configuration for the fa-ui-m8 hardened_ui_m8 compose stack."""
...
HARDENED_STACK_ROOT = EXAMPLE_ROOT.parent / "hardened_ui_m8"

configure_from_env(
    # Issuer: fa-auth-m8 auth_user_service (API_PREFIX=/user).
    auth_base_url="http://localhost:9000/user",
    # Downstream fastapi-m8 consumer in this stack: media-service (API_PREFIX=/media).
